...
2. Observe correlations between socioeconomic demographics and energy usage.

## Approach and Coding
We have limited our research to the UK Power Network (UKPN) Distribution Network Operator (DNO) and its EPN license area, East England, because of the greater data availability, diverse demographic variability, and general computing and storage limits. The data available is for the month of February 2024.
